"""
Clean library operation (legacy — archived).

Quarantined copy of the pre-v2 engine (dry-run canonicalization preflight,
pixel-level photo duplicate detection). Used when PHOTOS_CLEAN_LIBRARY_ENGINE=legacy.

Do not edit except critical fixes; active development is make_library_clean_v2.py.
"""

from __future__ import annotations

CLEAN_LIBRARY_ENGINE_VERSION = "legacy"
