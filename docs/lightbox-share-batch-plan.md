...
| 7 | Clear-selection CTA also hides overlay | 6 | app+share, narrow | session 0f18 (2026-08-27) | source done, needs share rebuild |
...
- Owner-dialed the ≤480 values (debug 2x removed): `--lightbox-info-font-size`
  `17px` (literal — equals the narrow `--modal-body-size` / toast message),
  `--lightbox-info-panel-pad-y` `24px`, `--lightbox-info-close-size` `28px`.
  Padding + close-X now run larger than the toast by choice.
