...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/share-overrides.css?v=1" />
  </head>
...
read_fragment shareAppBar.html >> "$OUT/index.html"

cat >> "$OUT/index.html" <<'HTML_MID'
      </div>
HTML_MID

read_fragment shareFilterChipRail.html >> "$OUT/index.html"

cat >> "$OUT/index.html" <<'HTML_MID2'
    </div>
HTML_MID2

read_fragment shareUtilitiesMenu.html >> "$OUT/index.html"
...
cat >> "$OUT/index.html" <<'HTML_TAIL'
    ...
    <script src="js/shareBoot.js"></script>
  </body>
</html>
HTML_TAIL
